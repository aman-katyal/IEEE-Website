...
- [ ] Task: Red Phase - Write failing tests for mobile accordion behavior
- [ ] Task: Green Phase - Implement sectioned grid layout with headings in `OfficersPage.tsx`
- [ ] Task: Green Phase - Implement mobile accordions for categories using Radix UI or custom logic
