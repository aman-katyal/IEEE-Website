...
import { A as identity, D as operate, E as createOperatorSubscriber, H as __spreadArray, L as createErrorClass, O as Observable, R as isFunction, V as __read, a as getVersionId, d as mergeMap, f as mapOneOrManyArgs, h as innerFrom, i as getVersionFromId, j as SafeSubscriber, k as pipe, l as filter, m as executeSchedule, n as getDraftId, o as isDraftId, p as map, r as getPublishedId, s as isVersionId, u as defer } from "./resolveEditInfo-TlN2Bg6g.js";
import { a as from, c as popScheduler, d as AsyncAction, i as mergeAll, l as isScheduler, n as share, r as merge, s as popResultSelector, t as shareReplay, u as AsyncScheduler } from "./shareReplay-Bx6GH8Em.js";
import { n as stegaClean, t as isRecord } from "./stegaClean-D7kHfglD.js";
...
function _fetch(client, httpRequest, _stega, query, _params = {}, options = {}) {
	...
	return stega.enabled ? $request.pipe(combineLatestWith(from(import("./stegaEncodeSourceMap-DhgnQb4H.js").then(function(n) {
...
var pick = (obj, props) => props.reduce((selection, prop) => (typeof obj[prop] > "u" || (selection[prop] = obj[prop]), selection), {}), eventSourcePolyfill = defer(() => import("./browser-DZ_saJS8.js").then((m) => /* @__PURE__ */ __toESM(m.default, 1))).pipe(map(({ default: EventSource2 }) => EventSource2), shareReplay(1));
