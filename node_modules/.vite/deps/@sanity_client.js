...
var pick = (obj, props) => props.reduce((selection, prop) => (typeof obj[prop] > "u" || (selection[prop] = obj[prop]), selection), {}), eventSourcePolyfill = defer(() => import("./browser-DuIW38Ty.js").then((m) => /* @__PURE__ */ __toESM(m.default, 1))).pipe(map(({ default: EventSource2 }) => EventSource2), shareReplay(1));
