...
...and ${allItems.length - MAX_ITEMS_IN_ERROR_MESSAGE} more`), props.message = `${error.description}${itemsStr}`, props.details = body.error, props;
  ...
  if (isQueryParseError(error)) {
    const tag = (_b = (_a2 = context == null ? void 0 : context.options) == null ? void 0 : _a2.query) == null ? void 0 : _b.tag;
...
function requestOptions(config, overrides = {}) {
  ...
  const withCredentials = !!(typeof overrides.withCredentials > "u" ? config.withCredentials : overrides.withCredentials), timeout2 = typeof overrides.timeout > "u" ? config.timeout : overrides.timeout;
...
function _upload(client, httpRequest, assetType, body, opts = {}) {
  ...
  const config = client.config(), options = optionsFromFile(opts, body), { tag, label, title, description, creditLine, filename, source } = options, isMediaLibrary = ((_a2 = config.resource) == null ? void 0 : _a2.type) === "media-library", query = isMediaLibrary ? {
...
var ObservableDatasetsClient = class {
  ...
  list() {
    ...
    const config = __privateGet(this, _client10).config(), projectId2 = config.projectId;
    let uri = "/datasets";
    return config.useProjectHostname === false && (uri = `/projects/${projectId2}/datasets`), _request(__privateGet(this, _client10), __privateGet(this, _httpRequest5), {
      uri,
      tag: null
    });
  }
...
var DatasetsClient = class {
  ...
  list() {
    ...
    const config = __privateGet(this, _client11).config(), projectId2 = config.projectId;
    let uri = "/datasets";
...
var ObservableMediaLibraryVideoClient = class {
  ...
  getPlaybackInfo(assetIdentifier, options = {}) {
    var _a2;
    const config = __privateGet(this, _client12).config(), configMediaLibraryId = (_a2 = config.resource || config["~experimental_resource"]) == null ? void 0 : _a2.id, { instanceId, libraryId } = parseAssetInstanceId(assetIdentifier), effectiveLibraryId = libraryId || configMediaLibraryId;
...
var _ObservableSanityClient = class _ObservableSanityClient {
  constructor(httpRequest, config = defaultConfig) {
    ...
    this.config(config), __privateSet(this, _httpRequest15, httpRequest), this.assets = new ObservableAssetsClient(this, __privateGet(this, _httpRequest15)), this.datasets = new ObservableDatasetsClient(this, __privateGet(this, _httpRequest15)), this.live = new LiveClient(this), this.mediaLibrary = {
...
var _SanityClient = class _SanityClient {
  constructor(httpRequest, config = defaultConfig) {
     ...
     */
    __publicField(this, "listen", _listen);
    this.config(config), __privateSet(this, _httpRequest16, httpRequest), this.assets = new AssetsClient(this, __privateGet(this, _httpRequest16)), this.datasets = new DatasetsClient(this, __privateGet(this, _httpRequest16)), this.live = new LiveClient(this), this.mediaLibrary = {
    ...
    }, this.releases = new ReleasesClient(this, __privateGet(this, _httpRequest16)), this.observable = new ObservableSanityClient(httpRequest, config);
  }
  /**
   * Clone the client - returns a new instance
   */
