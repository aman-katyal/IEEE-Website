...
import {
  ...
  take,
  takeUntil
} from "./chunk-ZU3V2UTR.js";
import {
  __commonJS,
  __toESM
} from "./chunk-OCBYBPSH.js";

// ../../../../aman/Documents/Programming/IEEE Website/node_modules/react/cjs/react-compiler-runtime.development.js
var require_react_compiler_runtime_development = __commonJS({
  "../../../../aman/Documents/Programming/IEEE Website/node_modules/react/cjs/react-compiler-runtime.development.js"(exports) {
    "use strict";
    (function() {
...
// ../../../../aman/Documents/Programming/IEEE Website/node_modules/react/compiler-runtime.js
var require_compiler_runtime = __commonJS({
  "../../../../aman/Documents/Programming/IEEE Website/node_modules/react/compiler-runtime.js"(exports, module) {
    "use strict";
    if (false) {
      module.exports = null;
    } else {
...
// ../../../../aman/Documents/Programming/IEEE Website/node_modules/lodash/isObject.js
var require_isObject = __commonJS({
  "../../../../aman/Documents/Programming/IEEE Website/node_modules/lodash/isObject.js"(exports, module) {
...
// ../../../../aman/Documents/Programming/IEEE Website/node_modules/uuid/dist/regex.js
var regex_default = /^(?:[0-9a-f]{8}-[0-9a-f]{4}-[1-8][0-9a-f]{3}-[89ab][0-9a-f]{3}-[0-9a-f]{12}|00000000-0000-0000-0000-000000000000|ffffffff-ffff-ffff-ffff-ffffffffffff)$/i;

// ../../../../aman/Documents/Programming/IEEE Website/node_modules/uuid/dist/validate.js
function validate(uuid) {
  return typeof uuid === "string" && regex_default.test(uuid);
}
var validate_default = validate;

// ../../../../aman/Documents/Programming/IEEE Website/node_modules/uuid/dist/parse.js
function parse(uuid) {
...
// ../../../../aman/Documents/Programming/IEEE Website/node_modules/uuid/dist/stringify.js
var byteToHex = [];
for (let i = 0; i < 256; ++i) {
...
// ../../../../aman/Documents/Programming/IEEE Website/node_modules/uuid/dist/rng.js
var getRandomValues;
...
// ../../../../aman/Documents/Programming/IEEE Website/node_modules/uuid/dist/md5.js
function md5(bytes) {
...
function wordsToMd5(x2, len) {
  ...
  for (let i = 0; i < x2.length; i += 16) {
    ...
    const oldc = c3;
    const oldd = d2;
    a2 = md5ff(a2, b, c3, d2, x2[i], 7, -680876936);
    d2 = md5ff(d2, a2, b, c3, x2[i + 1], 12, -389564586);
    c3 = md5ff(c3, d2, a2, b, x2[i + 2], 17, 606105819);
    b = md5ff(b, c3, d2, a2, x2[i + 3], 22, -1044525330);
    a2 = md5ff(a2, b, c3, d2, x2[i + 4], 7, -176418897);
    d2 = md5ff(d2, a2, b, c3, x2[i + 5], 12, 1200080426);
    c3 = md5ff(c3, d2, a2, b, x2[i + 6], 17, -1473231341);
    b = md5ff(b, c3, d2, a2, x2[i + 7], 22, -45705983);
    a2 = md5ff(a2, b, c3, d2, x2[i + 8], 7, 1770035416);
    d2 = md5ff(d2, a2, b, c3, x2[i + 9], 12, -1958414417);
    c3 = md5ff(c3, d2, a2, b, x2[i + 10], 17, -42063);
    b = md5ff(b, c3, d2, a2, x2[i + 11], 22, -1990404162);
    a2 = md5ff(a2, b, c3, d2, x2[i + 12], 7, 1804603682);
    d2 = md5ff(d2, a2, b, c3, x2[i + 13], 12, -40341101);
    c3 = md5ff(c3, d2, a2, b, x2[i + 14], 17, -1502002290);
    b = md5ff(b, c3, d2, a2, x2[i + 15], 22, 1236535329);
    a2 = md5gg(a2, b, c3, d2, x2[i + 1], 5, -165796510);
    d2 = md5gg(d2, a2, b, c3, x2[i + 6], 9, -1069501632);
    c3 = md5gg(c3, d2, a2, b, x2[i + 11], 14, 643717713);
    b = md5gg(b, c3, d2, a2, x2[i], 20, -373897302);
    a2 = md5gg(a2, b, c3, d2, x2[i + 5], 5, -701558691);
    d2 = md5gg(d2, a2, b, c3, x2[i + 10], 9, 38016083);
    c3 = md5gg(c3, d2, a2, b, x2[i + 15], 14, -660478335);
    b = md5gg(b, c3, d2, a2, x2[i + 4], 20, -405537848);
    a2 = md5gg(a2, b, c3, d2, x2[i + 9], 5, 568446438);
    d2 = md5gg(d2, a2, b, c3, x2[i + 14], 9, -1019803690);
    c3 = md5gg(c3, d2, a2, b, x2[i + 3], 14, -187363961);
    b = md5gg(b, c3, d2, a2, x2[i + 8], 20, 1163531501);
    a2 = md5gg(a2, b, c3, d2, x2[i + 13], 5, -1444681467);
    d2 = md5gg(d2, a2, b, c3, x2[i + 2], 9, -51403784);
    c3 = md5gg(c3, d2, a2, b, x2[i + 7], 14, 1735328473);
    b = md5gg(b, c3, d2, a2, x2[i + 12], 20, -1926607734);
    a2 = md5hh(a2, b, c3, d2, x2[i + 5], 4, -378558);
    d2 = md5hh(d2, a2, b, c3, x2[i + 8], 11, -2022574463);
    c3 = md5hh(c3, d2, a2, b, x2[i + 11], 16, 1839030562);
    b = md5hh(b, c3, d2, a2, x2[i + 14], 23, -35309556);
    a2 = md5hh(a2, b, c3, d2, x2[i + 1], 4, -1530992060);
    d2 = md5hh(d2, a2, b, c3, x2[i + 4], 11, 1272893353);
    c3 = md5hh(c3, d2, a2, b, x2[i + 7], 16, -155497632);
    b = md5hh(b, c3, d2, a2, x2[i + 10], 23, -1094730640);
    a2 = md5hh(a2, b, c3, d2, x2[i + 13], 4, 681279174);
    d2 = md5hh(d2, a2, b, c3, x2[i], 11, -358537222);
    c3 = md5hh(c3, d2, a2, b, x2[i + 3], 16, -722521979);
    b = md5hh(b, c3, d2, a2, x2[i + 6], 23, 76029189);
    a2 = md5hh(a2, b, c3, d2, x2[i + 9], 4, -640364487);
    d2 = md5hh(d2, a2, b, c3, x2[i + 12], 11, -421815835);
    c3 = md5hh(c3, d2, a2, b, x2[i + 15], 16, 530742520);
    b = md5hh(b, c3, d2, a2, x2[i + 2], 23, -995338651);
    a2 = md5ii(a2, b, c3, d2, x2[i], 6, -198630844);
    d2 = md5ii(d2, a2, b, c3, x2[i + 7], 10, 1126891415);
    c3 = md5ii(c3, d2, a2, b, x2[i + 14], 15, -1416354905);
    b = md5ii(b, c3, d2, a2, x2[i + 5], 21, -57434055);
    a2 = md5ii(a2, b, c3, d2, x2[i + 12], 6, 1700485571);
    d2 = md5ii(d2, a2, b, c3, x2[i + 3], 10, -1894986606);
    c3 = md5ii(c3, d2, a2, b, x2[i + 10], 15, -1051523);
    b = md5ii(b, c3, d2, a2, x2[i + 1], 21, -2054922799);
    a2 = md5ii(a2, b, c3, d2, x2[i + 8], 6, 1873313359);
    d2 = md5ii(d2, a2, b, c3, x2[i + 15], 10, -30611744);
    c3 = md5ii(c3, d2, a2, b, x2[i + 6], 15, -1560198380);
    b = md5ii(b, c3, d2, a2, x2[i + 13], 21, 1309151649);
    a2 = md5ii(a2, b, c3, d2, x2[i + 4], 6, -145523070);
    d2 = md5ii(d2, a2, b, c3, x2[i + 11], 10, -1120210379);
    c3 = md5ii(c3, d2, a2, b, x2[i + 2], 15, 718787259);
    b = md5ii(b, c3, d2, a2, x2[i + 9], 21, -343485551);
    a2 = safeAdd(a2, olda);
    b = safeAdd(b, oldb);
    c3 = safeAdd(c3, oldc);
    d2 = safeAdd(d2, oldd);
  }
  return Uint32Array.of(a2, b, c3, d2);
}
...
function md5cmn(q, a2, b, x2, s, t) {
  return safeAdd(bitRotateLeft(safeAdd(safeAdd(a2, q), safeAdd(x2, t)), s), b);
}
function md5ff(a2, b, c3, d2, x2, s, t) {
  return md5cmn(b & c3 | ~b & d2, a2, b, x2, s, t);
}
function md5gg(a2, b, c3, d2, x2, s, t) {
  return md5cmn(b & d2 | c3 & ~d2, a2, b, x2, s, t);
}
function md5hh(a2, b, c3, d2, x2, s, t) {
  return md5cmn(b ^ c3 ^ d2, a2, b, x2, s, t);
}
function md5ii(a2, b, c3, d2, x2, s, t) {
  return md5cmn(c3 ^ (b | ~d2), a2, b, x2, s, t);
}
var md5_default = md5;

// ../../../../aman/Documents/Programming/IEEE Website/node_modules/uuid/dist/v35.js
...
// ../../../../aman/Documents/Programming/IEEE Website/node_modules/uuid/dist/v3.js
...
// ../../../../aman/Documents/Programming/IEEE Website/node_modules/uuid/dist/native.js
var randomUUID = typeof crypto !== "undefined" && crypto.randomUUID && crypto.randomUUID.bind(crypto);
var native_default = { randomUUID };

// ../../../../aman/Documents/Programming/IEEE Website/node_modules/uuid/dist/v4.js
...
// ../../../../aman/Documents/Programming/IEEE Website/node_modules/uuid/dist/sha1.js
function f(s, x2, y, z) {
  switch (s) {
    case 0:
      return x2 & y ^ ~x2 & z;
...
function sha1(bytes) {
  ...
  for (let i = 0; i < N; ++i) {
    ...
    for (let t = 0; t < 80; ++t) {
      ...
      const T2 = ROTL(a2, 5) + f(s, b, c3, d2) + e + K[s] + W[t] >>> 0;
      e = d2;
      d2 = c3;
      c3 = ROTL(b, 30) >>> 0;
      b = a2;
...
// ../../../../aman/Documents/Programming/IEEE Website/node_modules/uuid/dist/v5.js
...
// ../../../../aman/Documents/Programming/IEEE Website/node_modules/xstate/dev/dist/xstate-dev.development.esm.js
function getGlobal() {
...
// ../../../../aman/Documents/Programming/IEEE Website/node_modules/xstate/dist/raise-cb04d847.development.esm.js
var Mailbox = class {
...
var Actor = class {
  ...
  constructor(logic, options) {
    ...
    this._actorScope = {
      ...
      emit: (emittedEvent) => {
        const listeners2 = this.eventListeners.get(emittedEvent.type);
        const wildcardListener = this.eventListeners.get("*");
        if (!listeners2 && !wildcardListener) {
          return;
        }
        const allListeners = [...listeners2 ? listeners2.values() : [], ...wildcardListener ? wildcardListener.values() : []];
  ...
  on(type, handler) {
    let listeners2 = this.eventListeners.get(type);
    if (!listeners2) {
      listeners2 = /* @__PURE__ */ new Set();
      this.eventListeners.set(type, listeners2);
    }
    const wrappedHandler = handler.bind(void 0);
    listeners2.add(wrappedHandler);
    return {
      unsubscribe: () => {
        listeners2.delete(wrappedHandler);
      }
    };
  }
...
function getCandidates(stateNode, receivedEventType) {
  const candidates = stateNode.transitions.get(receivedEventType) || [...stateNode.transitions.keys()].filter((eventDescriptor) => matchesEventDescriptor(receivedEventType, eventDescriptor)).sort((a2, b) => b.length - a2.length).flatMap((key) => stateNode.transitions.get(key));
  return candidates;
}
...
function microstep(transitions, currentSnapshot, actorScope, event, isInitial, internalQueue) {
  ...
  try {
    ...
    if (nextState.status === "done") {
      nextState = resolveActionsAndContext(nextState, event, actorScope, nextStateNodes.sort((a2, b) => b.order - a2.order).flatMap((state) => state.exit), internalQueue, void 0);
    }
    try {
...
// ../../../../aman/Documents/Programming/IEEE Website/node_modules/xstate/actors/dist/xstate-actors.development.esm.js
  ...
  const logic = {
    ...
    transition: (state, event, actorScope) => {
      ...
      if (event.type === XSTATE_STOP) {
        ...
        (_a = callbackState.receivers) == null ? void 0 : _a.clear();
        (_b = callbackState.dispose) == null ? void 0 : _b.call(callbackState);
        return state;
      }
      (_c = callbackState.receivers) == null ? void 0 : _c.forEach((receiver) => receiver(event));
      return state;
    },
    getInitialSnapshot: (_2, input) => {
      return {
...
// ../../../../aman/Documents/Programming/IEEE Website/node_modules/xstate/dist/assign-2343d091.development.esm.js
...
// ../../../../aman/Documents/Programming/IEEE Website/node_modules/xstate/dist/StateMachine-65637d4d.development.esm.js
...
// ../../../../aman/Documents/Programming/IEEE Website/node_modules/xstate/dist/log-39288d72.development.esm.js
...
// ../../../../aman/Documents/Programming/IEEE Website/node_modules/xstate/dist/xstate.development.esm.js
...
// ../../../../aman/Documents/Programming/IEEE Website/node_modules/@sanity/comlink/dist/index.js
  ...
  actions: {
    ...
    "on fail": sendTo(
      ...
      ({ context, self: self2 }) => {
        ...
        ), (_a = context.resolvable) == null ? void 0 : _a.reject(new Error("No response received")), { type: "request.failed", requestId: self2.id };
      }
    ),
    "on abort": sendTo(
      ({ context }) => context.parentRef,
      ({ context, self: self2 }) => {
        var _a;
        return (_a = context.resolvable) == null ? void 0 : _a.reject(new Error("Request aborted")), { type: "request.aborted", requestId: self2.id };
      }
    )
  },
  guards: {
...
var createNodeMachine = () => setup({
  ...
  actions: {
    ...
    "create request": assign({
      requests: ({ context, event, self: self2, spawn }) => {
        ...
        const requests = (Array.isArray(event.data) ? event.data : [event.data]).map((request) => {
          ...
          return spawn("requestMachine", {
            ...
            input: {
              ...
              responseTimeout: (_a = request.options) == null ? void 0 : _a.responseTimeout,
              responseTo: request.responseTo,
              signal: (_b = request.options) == null ? void 0 : _b.signal,
              sources: context.target,
              suppressWarnings: (_c = request.options) == null ? void 0 : _c.suppressWarnings,
...
// ../../../../aman/Documents/Programming/IEEE Website/node_modules/@sanity/presentation-comlink/dist/index.js
...
// ../../../../aman/Documents/Programming/IEEE Website/node_modules/@sanity/visual-editing/dist/_chunks-es/mutations.js
var import_compiler_runtime = __toESM(require_compiler_runtime(), 1);

// ../../../../aman/Documents/Programming/IEEE Website/node_modules/@sanity/mutate/dist/index.js
var import_isObject = __toESM(require_isObject());

// ../../../../aman/Documents/Programming/IEEE Website/node_modules/@sanity/mutate/dist/_chunks-es/parse.js
...
// ../../../../aman/Documents/Programming/IEEE Website/node_modules/@sanity/mutate/dist/_chunks-es/stringify.js
function safeGetElementAt(array, index2) {
...
// ../../../../aman/Documents/Programming/IEEE Website/node_modules/@sanity/mutate/dist/_chunks-es/arrify.js
function arrify(val) {
  return Array.isArray(val) ? val : [val];
}

// ../../../../aman/Documents/Programming/IEEE Website/node_modules/@sanity/mutate/dist/_chunks-es/encode.js
...
function getInsertPosition(insert2) {
  const positions = POSITION_KEYS.filter((k) => k in insert2);
...
function decodeNodePatches(patch2) {
  return [
    ...getSetPatches(patch2),
    ...getSetIfMissingPatches(patch2),
    ...getUnsetPatches(patch2),
    ...getIncPatches(patch2),
    ...getDecPatches(patch2),
    ...getInsertPatches(patch2),
    ...getDiffMatchPatchPatches(patch2)
  ];
}
function getSetPatches(patch2) {
  return isSetPatch(patch2) ? Object.keys(patch2.set).map((path) => ({
    path: parse2(path),
    op: { type: "set", value: patch2.set[path] }
  })) : [];
}
function getSetIfMissingPatches(patch2) {
  return isSetIfMissingPatch(patch2) ? Object.keys(patch2.setIfMissing).map((path) => ({
    path: parse2(path),
    op: { type: "setIfMissing", value: patch2.setIfMissing[path] }
  })) : [];
}
function getDiffMatchPatchPatches(patch2) {
  return isDiffMatchPatch(patch2) ? Object.keys(patch2.diffMatchPatch).map((path) => ({
    path: parse2(path),
    op: { type: "diffMatchPatch", value: patch2.diffMatchPatch[path] }
  })) : [];
}
function getUnsetPatches(patch2) {
  return isUnsetPatch(patch2) ? patch2.unset.map((path) => ({
    path: parse2(path),
    op: { type: "unset" }
  })) : [];
}
function getIncPatches(patch2) {
  return isIncPatch(patch2) ? Object.keys(patch2.inc).map((path) => ({
    path: parse2(path),
    op: { type: "inc", amount: patch2.inc[path] }
  })) : [];
}
function getDecPatches(patch2) {
  return isDecPatch(patch2) ? Object.keys(patch2.dec).map((path) => ({
    path: parse2(path),
    op: { type: "dec", amount: patch2.dec[path] }
  })) : [];
}
function getInsertPatches(patch2) {
  if (!isInsertPatch(patch2))
    return [];
  const position = getInsertPosition(patch2.insert);
  if (!position)
    throw new Error("Insert patch missing position");
  const path = parse2(patch2.insert[position]), referenceItem = path.pop(), op = position === "replace" ? {
    type: "insert",
    position,
    referenceItem,
...
// ../../../../aman/Documents/Programming/IEEE Website/node_modules/@sanity/mutate/dist/_chunks-es/isObject.js
...
function decodePatchMutation(mutation) {
  const [, type, id, serializedPath, , revisionId] = mutation, path = parse2(serializedPath);
...
function encodeMutation$1(mutation) {
  ...
  if (mutation.type === "patch")
    return mutation.patches.map(
      (patch2) => {
        var _a;
        return maybeAddRevision(
          (_a = mutation.options) == null ? void 0 : _a.ifRevision,
...
function at(path, operation) {
  return {
    path: typeof path == "string" ? parse2(path) : path,
    op: operation
  };
}
...
// ../../../../aman/Documents/Programming/IEEE Website/node_modules/@sanity/visual-editing/dist/_chunks-es/context.js
var emptyActor = createEmptyActor();
var actor = emptyActor;
...
function useOptimisticActor() {
  return (0, import_react.useSyncExternalStore)(_temp, _temp2, _temp3);
}
function _temp3() {
  return emptyActor;
}
...
function useOptimisticActorReady() {
  const $ = (0, import_compiler_runtime.c)(2), actor2 = useOptimisticActor();
  let t0;
...
function getDocumentsAndSnapshot(id, actor2) {
  ...
  const draftId = getDraftId(id), publishedId = getPublishedId(id), documents = (_a = actor2.getSnapshot().context) == null ? void 0 : _a.documents, draftDoc = documents == null ? void 0 : documents[draftId], publishedDoc = documents == null ? void 0 : documents[publishedId], doc = draftDoc || publishedDoc;
  if (!doc)
    throw new Error(`Document "${id}" not found`);
  const snapshot = ((_b = draftDoc.getSnapshot().context) == null ? void 0 : _b.local) || ((_c = publishedDoc.getSnapshot().context) == null ? void 0 : _c.local), snapshotPromise = new Promise((resolve) => {
    if (snapshot)
      resolve(snapshot);
    else {
...
function useDocuments() {
  const $ = (0, import_compiler_runtime.c)(7), actor2 = useOptimisticActor();
  let t0;
  ...
  $[2] !== actor2 ? (t1 = (id, mutations, options) => {
    const {
      ...
      commit: t22
    } = options || {}, commit = t22 === void 0 ? true : t22;
    draftDoc.send({
      type: "mutate",
      mutations
    }), commit && (typeof commit == "object" && "debounce" in commit ? debounce(() => draftDoc.send({
...
function whatwgRNG(length = 16) {
  const rnds83 = new Uint8Array(length);
  return crypto.getRandomValues(rnds83), rnds83;
}
...
function getArrayItemKeyAndParentPath(pathOrNode) {
  ...
  if (lastPathItem.includes("_key")) {
    ...
    key = lastPathItem.substring(startIndex, endIndex), hasExplicitKey = true;
  } else {
    const startIndex = lastPathItem.indexOf("[") + 1, endIndex = lastPathItem.indexOf("]", startIndex);
    key = lastPathItem.substring(startIndex, endIndex), hasExplicitKey = false;
  }
...
// ../../../../aman/Documents/Programming/IEEE Website/node_modules/valibot/dist/index.mjs
var store$4;
...
// ../../../../aman/Documents/Programming/IEEE Website/node_modules/@sanity/visual-editing-csm/dist/index.js
var lengthyStr$1 = pipe2(string(), minLength(1));
var optionalLengthyStr = optional(lengthyStr$1);
var sanityNodeSchema = object({
...
var lengthyStr = pipe2(string(), minLength(1));
var sanityLegacyNodeSchema = object({
  origin: lengthyStr,
  href: lengthyStr,
...
function decodeSanityObject(data) {
  ...
  if (sanityLegacyNode.success)
    try {
      ...
      return url.searchParams.size > 0 ? parse3(sanityNodeSchema, Object.fromEntries(url.searchParams.entries())) : sanityLegacyNode.output;
    } catch (err) {
...
// ../../../../aman/Documents/Programming/IEEE Website/node_modules/@sanity/visual-editing/dist/_chunks-es/SharedStateContext.js
var import_compiler_runtime2 = __toESM(require_compiler_runtime(), 1);
var import_react2 = __toESM(require_react(), 1);

// ../../../../aman/Documents/Programming/IEEE Website/node_modules/@vercel/stega/dist/index.mjs
var l = { 0: 8203, 1: 8204, 2: 8205, 3: 8290, 4: 8291, 5: 8288, 6: 65279, 7: 8289, 8: 119155, 9: 119156, a: 119157, b: 119158, c: 119159, d: 119160, e: 119161, f: 119162 };
var d = { 0: 8203, 1: 8204, 2: 8205, 3: 65279 };
var a = { 0: String.fromCodePoint(d[0]), 1: String.fromCodePoint(d[1]), 2: String.fromCodePoint(d[2]), 3: String.fromCodePoint(d[3]) };
var p = new Array(4).fill(String.fromCodePoint(d[0])).join("");
var m = String.fromCharCode(0);
var g = Object.fromEntries(Object.entries(a).map((t) => [t[1], +t[0]]));
var T = Object.fromEntries(Object.entries(l).map((t) => t.reverse()));
var _ = `${Object.values(l).map((t) => `\\u{${t.toString(16)}}`).join("")}`;
var u = new RegExp(`[${_}]{4,}`, "gu");
function X(t) {
  let e = t.match(u);
  if (e) return x(e[0], true)[0];
}
function x(t, e = false) {
  ...
  let c3 = new TextDecoder().decode(i);
  if (e) {
    let o = c3.indexOf(m);
    return o === -1 && (o = c3.length), [JSON.parse(c3.slice(0, o))];
  }
  return c3.split(m).filter(Boolean).map((o) => JSON.parse(o));
}
function I(t, e) {
  var o;
  let r = [];
  for (let s = t.length * 0.5; s--; ) {
    let f2 = `${T[t[s * 2].codePointAt(0)]}${T[t[s * 2 + 1].codePointAt(0)]}`;
    r.unshift(String.fromCharCode(parseInt(f2, 16)));
  }
  let n = [], i = [r.join("")], c3 = 10;
  for (; i.length; ) {
    let s = i.shift();
    try {
      ...
      if (!c3--) throw f2;
      let E = +((o = f2.message.match(/\sposition\s(\d+)$/)) == null ? void 0 : o[1]);
      if (!E) throw f2;
...
function useOptimistic(passthrough, reducer) {
  const $ = (0, import_compiler_runtime2.c)(17), [pristine, setPristine] = (0, import_react2.useState)(true), [optimistic, setOptimistic] = (0, import_react2.useState)(passthrough), [lastEvent, setLastEvent] = (0, import_react2.useState)(null), [lastPassthrough, setLastPassthrough] = (0, import_react2.useState)(passthrough), actor2 = useOptimisticActor(), reduceStateFromActionRef = (0, import_react2.useRef)(null);
  let t0, t1;
  $[0] !== reducer ? (t0 = () => {
  ...
  }, t1 = [reducer], $[0] = reducer, $[1] = t0, $[2] = t1) : (t0 = $[1], t1 = $[2]), (0, import_react2.useInsertionEffect)(t0, t1);
  let t2;
  $[3] !== passthrough ? (t2 = () => setLastPassthrough(passthrough), $[3] = passthrough, $[4] = t2) : t2 = $[4];
  const updateLastPassthroughRef = (0, import_react2.useRef)(t2);
  let t3, t4;
  $[5] !== passthrough ? (t3 = () => {
    updateLastPassthroughRef.current = () => setLastPassthrough(passthrough);
  }, t4 = [passthrough], $[5] = passthrough, $[6] = t3, $[7] = t4) : (t3 = $[6], t4 = $[7]), (0, import_react2.useInsertionEffect)(t3, t4);
  let t5, t6;
  $[8] !== actor2 ? (t5 = () => {
    ...
    const rebasedSub = actor2.on("rebased.local", (_event) => {
      ...
      pristineTimeout = setTimeout(() => {
        (0, import_react2.startTransition)(() => setPristine(true));
      }, 15e3);
    });
    return () => {
      rebasedSub.unsubscribe(), pristineSub.unsubscribe();
    };
  }, t6 = [actor2], $[8] = actor2, $[9] = t5, $[10] = t6) : (t5 = $[9], t6 = $[10]), (0, import_react2.useEffect)(t5, t6);
  let t7, t8;
  return $[11] !== lastEvent || $[12] !== lastPassthrough || $[13] !== passthrough || $[14] !== pristine ? (t7 = () => {
    if (!pristine) {
      ...
      lastPassthrough !== passthrough && (0, import_react2.startTransition)(() => {
  ...
  }, t8 = [lastEvent, lastPassthrough, passthrough, pristine], $[11] = lastEvent, $[12] = lastPassthrough, $[13] = passthrough, $[14] = pristine, $[15] = t7, $[16] = t8) : (t7 = $[15], t8 = $[16]), (0, import_react2.useEffect)(t7, t8), pristine ? passthrough : optimistic;
}
var byteToHex2 = [];
for (let i = 0; i < 256; ++i)
...
var randomUUID2 = typeof crypto < "u" && crypto.randomUUID && crypto.randomUUID.bind(crypto);
var native = {
...
function v42(options, buf, offset) {
  ...
  options = options || {};
  const rnds = options.random ?? ((_a = options.rng) == null ? void 0 : _a.call(options)) ?? rng2();
  if (rnds.length < 16)
    throw new Error("Random bytes length must be >= 16");
...
function rayIntersect(l1, l2) {
  ...
  if (ua < 0 || ua > 1 || ub < 0 || ub > 1)
    return false;
  const x5 = x1 + ua * (x2 - x1), y = y1 + ua * (y2 - y1);
  return {
    x: x5,
    y
  };
  ...
  for (let i = 0; i < rectLines.length; i++) {
    ...
    if (intersection) {
      ...
      for (let j = 0; j < intersections.length; j++)
        intersections[j].x === intersection.x && intersections[j].y === intersection.y && (isDuplicate = true);
      isDuplicate || intersections.push(intersection);
    }
  }
  return intersections.length === 0 ? false : intersections.sort((a2, b) => pointDist(a2, {
    x: line.x1,
    y: line.y1
  }) - pointDist(b, {
    x: line.x1,
...
function pointDist(p1, p2) {
  const a2 = p1.x - p2.x, b = p1.y - p2.y;
...
function scaleRect(rect, scale, origin) {
  const {
    ...
    x: originX,
    y: originY
  } = origin, newX = originX + (x2 - originX) * scale, newY = originY + (y - originY) * scale, newWidth = w * scale, newHeight = h * scale;
  return {
    x: newX,
    y: newY,
    w: newWidth,
...
function findRectSanityData(rect, overlayGroup) {
  var _a;
  return (_a = overlayGroup.find((e) => rectEqual(getRect(e.elements.element), rect))) == null ? void 0 : _a.sanity;
}
...
var minimapScaleApplied = false;
var mousePosInverseTransform = {
  y: 0
};
var mousePos = {
  x: 0,
...
var prescaleHeight = typeof document > "u" ? 0 : document.documentElement.scrollHeight;
var previousRootStyleValues = null;
function handleOverlayDrag(opts) {
  ...
  const rectsInterval = setInterval(() => {
    ...
    Math.abs(e.deltaY) >= 10 && scaleFactor < 1 && !minimapScaleApplied && !minimapPromptShown && !disableMinimap && mousedown && (handler({
      type: "overlay/dragToggleMinimapPrompt",
      display: true
    }), minimapPromptShown = true), e.shiftKey && !minimapScaleApplied && !disableMinimap && (window.dispatchEvent(new CustomEvent("unstable_sanity/dragApplyMinimap")), minimapScaleApplied = true, setTimeout(() => {
      applyMinimap();
    }, 50));
  }, handleMouseMove = (e) => {
    ...
    handler({
      ...
      x: mousePos.x,
      y: mousePos.y
    }), e.shiftKey && !minimapScaleApplied && !disableMinimap && (window.dispatchEvent(new CustomEvent("unstable_sanity/dragApplyMinimap")), minimapScaleApplied = true, setTimeout(() => {
      applyMinimap();
    }, 50));
...
var isElementNode$1 = (target) => target instanceof HTMLElement || target instanceof SVGElement;
...
var findOverlayElement = (el) => {
  var _a;
  return !el || !isElementNode$1(el) ? null : ((_a = el.dataset) == null ? void 0 : _a.sanityOverlayElement) ? el : findOverlayElement(el.parentElement);
};
function testVercelStegaRegex(input) {
  return u.lastIndex = 0, u.test(input);
}
function decodeStega(str, isAltText = false) {
  var _a;
  try {
    const decoded = X(str);
    return !decoded || decoded.origin !== "sanity.io" ? null : (isAltText && (decoded.href = (_a = decoded.href) == null ? void 0 : _a.replace(".alt", "")), decoded);
  } catch (err) {
...
var isImgElement = (el) => el.tagName === "IMG";
var isTimeElement = (el) => el.tagName === "TIME";
var isSvgRootElement = (el) => el.tagName.toUpperCase() === "SVG";
...
function findCommonSanityData(nodes) {
  ...
  for (let i = 1; i < sanityNodes.length; i++) {
    ...
    if (consistentValueKeys.some((key) => node[key] !== (common == null ? void 0 : common[key]))) {
      common = void 0;
      break;
    }
    common = {
...
function findSanityNodes(el) {
  ...
  function resolveNode(node) {
    ...
    if (isElementNode(node) && ((_a = node.dataset) == null ? void 0 : _a.sanityEditTarget) !== void 0) {
      ...
      if (node.tagName === "SCRIPT" || node.tagName === "SANITY-VISUAL-EDITING")
        return;
      if ((_b = node.dataset) == null ? void 0 : _b.sanity)
      ...
      if ((_c = node.dataset) == null ? void 0 : _c.sanityEditInfo)
  ...
  function processNode(node, _parentGroup) {
    ...
    if (isElementNode(node) && ((_a = node.dataset) == null ? void 0 : _a.sanityEditGroup) !== void 0 && (parentGroup = {
      type: "group",
      elements: {
        element: node,
        measureElement: node
...
function resolveDragAndDropGroup(element, sanity, elementSet, elementsMap) {
  ...
  const targetDragGroup = element.getAttribute("data-sanity-drag-group"), group = [...elementSet].reduce((acc, el) => {
    ...
    return (elData == null ? void 0 : elData.sanity) && !elDragDisabled && isSanityNode(elData.sanity) && sanityNodesExistInSameArray(sanity, elData.sanity) && sharedDragGroup && elHasSanityAttribution && acc.push(elData), acc;
  }, []);
...
function createOverlayController({
    ...
    if (!(!inFrame && !inPopUp || !optimisticActorReady))
      for (const hoverstackElement of hoverStack) {
        if (element === hoverstackElement) {
          const targetSanityData = (_a = elementsMap.get(element)) == null ? void 0 : _a.sanity;
  ...
  function registerElement({
    ...
    const {
      ...
      click(event) {
        ...
        if (element === getHoveredElement() && element.contains(target)) {
          ...
          const sanity = (_a = elementsMap.get(element)) == null ? void 0 : _a.sanity;
      ...
      contextmenu(event) {
        var _a;
        if (!("path" in commonSanity) || !inFrame && !inPopUp || !optimisticActorReady || !((_a = commonSanity.path.split(".").pop()) == null ? void 0 : _a.includes("[_key=="))) return;
        const target = event.target;
    ...
    elementSet.add(element), measureElements.set(measureElement, element), elementIdMap.set(id, element), elementsMap.set(element, sanityNode), io == null ? void 0 : io.observe(element), handler({
  ...
  function handleMutation(mutations) {
    ...
    for (const mutation of mutations) {
      ...
      if (!(node === overlayElement || overlayElement.contains(node)) && (mutationWasInScope = true, isElementNode$1(node))) {
        const possibleGroupParent = ((_a = node.parentElement) == null ? void 0 : _a.closest("[data-sanity-edit-group]")) || null, updateNodeTarget = isElementNode$1(possibleGroupParent) ? possibleGroupParent : node;
        parseElements({
    ...
    if (mutationWasInScope)
      for (const element of elementSet)
        element.isConnected || unregisterElement(element), ((_b = elementsMap.get(element)) == null ? void 0 : _b.type) === "group" && !element.hasAttribute("data-sanity-edit-group") && unregisterElement(element);
  }
  ...
  function deactivate() {
    activated && (io == null ? void 0 : io.disconnect(), elementSet.forEach((element) => {
      const overlayElement2 = elementsMap.get(element);
...
var SharedStateContext = (0, import_react2.createContext)(null);
...
react/cjs/react-compiler-runtime.development.js:
   ...
   *)
*/
//# sourceMappingURL=chunk-J7DBFCF7.js.map
