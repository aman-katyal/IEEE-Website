        ...
        <div style={{ display: "flex", flexDirection: "column", gap: "48px" }}>
          ...
          <div style={{ display: "grid", gridTemplateColumns: "repeat(auto-fit, minmax(280px, 1fr))", gap: "24px" }}>
            <Card className="glass-card border-none bg-transparent shadow-none">
              <CardHeader className="flex flex-row items-center gap-4 space-y-0 pb-4 p-6">
                <Users size={24} style={{ color: "var(--electric-blue)" }} />
                <CardTitle style={{ fontFamily: "var(--font-headline)", fontSize: "20px", fontWeight: 600, color: "var(--text-primary)" }}>
                  Attend Meetings
                </CardTitle>
              </CardHeader>
          ...
          {/* Connect Section */}
          <Card 
            className="glass-card border-none p-0 shadow-none" 
            style={{ 
              background: isLight ? "rgba(88, 101, 242, 0.08)" : "rgba(88, 101, 242, 0.05)", 
              borderColor: isLight ? "rgba(88, 101, 242, 0.3)" : "rgba(88, 101, 242, 0.2)" 
            }}
          >
            <CardContent className="p-[clamp(24px,5vw,48px)]">
          ...
          <div style={{ marginTop: "32px" }}>
            ...
            <div className="ieee-grid-2" style={{ gap: "32px" }}>
              ...
              <Card 
                className="glass-card border-none p-0 shadow-none" 
                style={{ background: isLight ? "rgba(0, 90, 135, 0.05)" : "rgba(0, 98, 155, 0.05)" }}
              >
                <CardHeader className="p-[clamp(24px,5vw,40px)] pb-5">
                  <CardTitle style={{ fontFamily: "var(--font-headline)", fontSize: "18px", fontWeight: 600, color: "var(--cyber-gold)", textTransform: "uppercase", letterSpacing: "0.1em", opacity: isLight ? 1 : 0.9 }}>
                    2025-26 Options
                  </CardTitle>
                </CardHeader>
                <CardContent className="p-[clamp(24px,5vw,40px)] pt-0">
                  ...
                  <Button
                    asChild
                    variant="gold"
                    className="w-full py-6 gap-2 no-underline justify-center"
                  >
                    <a 
