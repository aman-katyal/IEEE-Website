    ...
    >
      ...
      >
        ...
        <div style={{ display: "flex", flexDirection: "column", gap: "48px" }}>
          ...
          {/* Connect Section */}
          <div className="glass-card" style={{ padding: "48px", background: "rgba(88, 101, 242, 0.05)", borderColor: "rgba(88, 101, 242, 0.2)" }}>
            <div style={{ display: "flex", gap: "32px", alignItems: "center", flexWrap: "wrap" }}>
              ...
              <div style={{ width: "120px", height: "120px", background: "rgba(88, 101, 242, 0.1)", borderRadius: "24px", display: "flex", alignItems: "center", justifyCenter: "center" }} className="hidden sm:flex">
          ...
          <div style={{ marginTop: "32px" }}>
            ...
            <div style={{ display: "grid", gridTemplateColumns: "1fr 1fr", gap: "48px" }} className="ieee-grid-2">
              ...
              <div className="glass-card" style={{ padding: "40px", background: "rgba(0, 98, 155, 0.05)" }}>
