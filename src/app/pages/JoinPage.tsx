...
export function JoinPage() {
  ...
  if (loading) {
    return (
      <div className="min-h-screen flex justify-center items-center bg-[var(--boiler-black)] text-[var(--text-primary)]">
        Loading...
      </div>
    );
  }
    ...
    <section className="bg-[var(--boiler-black)] min-h-screen pt-[120px] pb-24 relative overflow-hidden">
      ...
      <div className="relative z-5 max-w-[1000px] mx-auto px-8">
        ...
        <div className="flex flex-col gap-12">
          ...
          {/* Connect Section */}
          <div
            className={`glass-card p-[clamp(24px,5vw,48px)] ${isLight ? "bg-[#5865F214] border-[#5865F24D]" : "bg-[#5865F20D] border-[#5865F233]"}`}
          >
          ...
          <div className="mt-8">
            ...
            <div className="ieee-grid-2 gap-8">
              ...
              <div
                className={`glass-card p-[clamp(24px,5vw,40px)] ${isLight ? "bg-[rgba(0,90,135,0.05)]" : "bg-[rgba(0,98,155,0.05)]"}`}
              >
                <h4
