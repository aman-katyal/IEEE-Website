    ...
    >
      ...
      >
        ...
        <div style={{ display: "flex", alignItems: "center", justifyContent: "center" }}>
          <Card
            className="glass-card w-full max-w-[440px] border-none bg-transparent p-0 shadow-none"
          >
            <CardHeader className="items-center pb-2 text-center">
              ...
              <CardTitle className="font-headline text-2xl font-semibold text-[var(--text-primary)]">
                Join the Community
              </CardTitle>
              <CardDescription className="font-body mt-2 text-sm leading-relaxed text-[var(--text-secondary)]">
